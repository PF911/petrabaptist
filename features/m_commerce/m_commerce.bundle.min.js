...
return $pwaRequest.post("mcommerce/mobile_sales_stripe/removecard",{data:{"value_id":this.value_id,"customer_id":customer_id}})};return factory});Features.insertCSS(".module-mcommerce .saved-card{font-weight:700;letter-spacing:0}.module-mcommerce .saved-card .last-star{transform:translateY(3px);display:inline-block}","m_commerce")